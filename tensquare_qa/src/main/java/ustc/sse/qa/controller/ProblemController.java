package ustc.sse.qa.controller;
...
public class ProblemController {
    ...
    public Result newlist(@PathVariable("labelId") String labelId,
        ...
        return new Result(true, StatusCode.OK, "查询最新问题成功!", new PageResult<Problem>(problemPage.getTotalElements(), problemPage.getContent()));
    }
    ...
    public Result hotlist(@PathVariable("labelId") String labelId,
        ...
        return new Result(true, StatusCode.OK, "查询最热问题成功!", new PageResult<Problem>(problemPage.getTotalElements(), problemPage.getContent()));
    }
    ...
    public Result waitlist(@PathVariable("labelId") String labelId,
        ...
        return new Result(true, StatusCode.OK, "查询待解决问题成功!", new PageResult<Problem>(problemPage.getTotalElements(), problemPage.getContent()));
    }
    ...
    public Result add(@RequestBody Problem problem) {
        ...
        problem.setUserid(claims.getId()); // 设置问题的用户id
